...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	*/
		body,.backgroundColor{
			/*@editable*/background-color:#FFFFEE;
		}
		body{
			background-image:url('http://gallery.mailchimp.com/1681f9ec63117ca004520f7e7/images/bckg60.png');
	...
	*/
		h1{
			/*@editable*/color:#A30013 !important;
			display:block;
	...
	*/
		h2{
			/*@editable*/color:#3A6A44 !important;
			display:block;
			/*@editable*/font-family:Georgia;
	...
	*/
		h3{
			/*@editable*/color:#0E6624 !important;
			display:block;
	...
	*/
		#templatePreheader{
			/*@editable*/background-color:#F0EAD2;
			/*@editable*/border-top:0;
	...
	*/
		#templateBody{
			/*@editable*/background-color:#F0EAD2;
			/*@editable*/border-top:2px dashed #D2B48C;
			/*@editable*/border-bottom:0;
		}
	/*
	@tab Body
	...
	*/
		#templateColumns{
			/*@editable*/background-color:#F0EAD2;
			/*@editable*/border-top:0;
			/*@editable*/border-bottom:2px dashed #D2B48C;
		}
	/*
	@tab Columns
	...
	*/
		table[id=templateContainer],table[id=templatePreheader],table[id=templateHeader],table[id=templateColumns],table[class=templateColumn],table[id=templateBody],table[id=templateFooter],table[class=flexibleContainer]{
			/*@tab Mobile Styles
@section template width
...
table.prodtable tr.row0 {
	background-color:#fff;
}
table.prodtable tr.row1 {
    ...
    <body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
        <div class="backgroundColor">
            <!--[if gte mso 9]>
                ...
                <v:fill type="tile" src="http://gallery.mailchimp.com/27aac8a65e64c994c4416d6b8/images/bg_pattern_topomap.png"/>
            	</v:background>
            <![endif]-->
            <center>
                <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable">
                    <tr>
                        <td align="center" background="http://gallery.mailchimp.com/1681f9ec63117ca004520f7e7/images/bckg60.png" valign="top" id="bodyCell">
                            <!-- BEGIN TEMPLATE // -->
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                                            <tr>
                                                <td align="center" valign="top">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="600" class="flexibleContainer">
                                                        <tr>
                                                            <td valign="top" class="headerContainer" style="padding-top:18px; padding-bottom:9px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnImageBlock">
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/4858b91a131c104feb2995802/images/logo_broodjechef_1.png" width="274" style="max-width:274px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top">
                                                                <table border="0" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        <td align="center" valign="bottom" style="padding-right:20px; padding-left:20px;">
                                                                            <img src="http://gallery.mailchimp.com/1681f9ec63117ca004520f7e7/images/topbag.png" height="65" width="300" class="flexibleImage" style="display:block; max-width:600px;">
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
    ...
    <tbody class="mcnDividerBlockOuter">
        <tr>
            <td class="mcnDividerBlockInner" style="padding: 18px 18px 9px;">
                <table class="mcnDividerContent" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-top-width: 2px;border-top-style: dashed;border-top-color: #D2B48C;">
                    <tbody><tr>
                        <td>
                            <span></span>
                        </td>
